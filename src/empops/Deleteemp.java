...
public class Deleteemp extends JFrame {
	...
	public Deleteemp() {
		...
		jLabel = new JLabel("Delete Employee Record");
		id = new JLabel("Id");
		...
		button1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					ps = db.Connec.getCon().prepareStatement("delete from empdetail where id =? ");
					ps.setString(1, id);
					ps.executeUpdate();
					JOptionPane.showMessageDialog(button1, "Employee with Id " + id + " has been removed from DB");
